...
public class AlgorithmFactory {
    ...
    static {
        ...
        // Si je le met dans ShortestPathAlgorithm, il apparaît dans la liste des algos
        registerAlgorithm(ElectricCarAlgorithm.class, "Electric Car", ElectricCarAlgorithm.class);
    }
